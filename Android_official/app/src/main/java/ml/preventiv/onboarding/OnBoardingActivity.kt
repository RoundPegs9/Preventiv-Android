...
//        btnNext = findViewById(R.id.btn_next)
        ...
        mList.add(
            ScreenItem(
                ...
                "Enable Bluetooth Scanning to check if someone near you has COVID-19 or is showing symptoms of it. This is a one-time process, enable it once and it'll continuously scan in the background.",
        ...
        mList.add(
            ScreenItem(
                "Connections",
                "You'll be notified via in-app notifications if someone you interacted with in the past 14 days hsa been infected with COVID-19.",
                R.drawable.network
            )
        )
        mList.add(
            ScreenItem(
                "Heat Map",
                "Find out which areas in your neighborhood are infected with COVID-19 so you can better plan your day.",
        ...
        mList.add(
            ScreenItem(
                "Privacy",
                "Preventiv uses Bluetooth LE and Differential Privacy algorithms to increase user privacy. All data is stored locally on your phone, creating a decentralized mesh net. Safety and Security are not binary, and shouldn't be treated as such.",
        ...
        mList.add(
            ScreenItem(
                "Preventiv Basics : 1",
                "To start using Preventiv, select the box that best describes how you've felt over the past 2 weeks.",
        ...
        mList.add(
            ScreenItem(
                "Preventiv Basics : 3",
                "Enable Bluetooth scanning to identify who near you is infected from the virus. Preventiv scans in the background without draining your phone's battery. Turning off your phone has no effect on Preventiv.",
