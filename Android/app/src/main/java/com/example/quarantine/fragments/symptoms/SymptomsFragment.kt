...
class SymptomsFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        fab.setOnClickListener {
            ...
            intent.putExtra(Intent.EXTRA_TEXT, "Preventiv - Bluetooth Based Contact Tracing App for COVID-19. Install Preventiv at [BETA]: https://bit.ly/preventiv_beta")
            intent.type = "text/plain"
            intent.putExtra(Intent.EXTRA_TITLE, "Send message to : ")
    ...
    private fun toggleVisibility(textView: TextView)
    {
        ...
        if (textView.visibility == View.INVISIBLE)
        {
            ...
            textView.setOnClickListener {
                Toast.makeText(activity!!.applicationContext, "Sorry, but thise feature is not available in BETA", Toast.LENGTH_SHORT).show()
            }
        }else
        {
